...
export const KINK_CATEGORY_DEFINITIONS = [
  ...
  { id: "bondage", label: "Bondage & Restraint", aliases: ["Bondage", "Vastbinden", "Beperking"], questionnaireExplainer: "Bondage & Restraint gaat over bewegingsvrijheid bewust beperken met touw, cuffs, houdingen of andere middelen. Comfort, circulatie, snelle bevrijding en duidelijke stopafspraken blijven leidend." },
