...
function Title({ children }: { children: React.ReactNode }) {
  return <motion.h2 variants={childV} className="serif-safe mt-3.5 text-[2rem] leading-[1.05]" style={{ fontFamily: 'var(--font-display, Georgia, serif)', fontWeight: 500 }}>{children}</motion.h2>;
}
...
function Welcome() {
  return (
    <div className="relative py-5 text-center">
      ...
      <motion.p variants={childV} className="relative mx-auto mt-9 max-w-xs text-lg font-medium leading-7">Ontdek samen wat jullie leuk vinden.</motion.p>
      <motion.p variants={childV} className="relative mx-auto mt-4 max-w-xs text-sm leading-6" style={{ color: 'var(--text2)' }}>Wat je wilt proberen.</motion.p>
      <motion.p variants={childV} className="relative mx-auto mt-3 max-w-xs text-sm leading-6" style={{ color: 'var(--text2)' }}>Wat je liever laat.</motion.p>
      <motion.p variants={childV} className="relative mx-auto mt-4 max-w-xs text-sm leading-6" style={{ color: 'var(--text2)' }}>En misschien iets waar jullie nog niet aan gedacht hadden.</motion.p>
    </div>
  );
}
...
function AgeGate() {
  return (
    <div>
      <motion.div variants={childV} className="mb-5 flex h-11 w-11 items-center justify-center rounded-2xl" style={{ background: 'var(--surface2)', color: 'var(--accent)' }}><ShieldWarning size={22} aria-hidden="true" /></motion.div>
      <Eyebrow>Voor we beginnen</Eyebrow>
      <Title>18+?</Title>
      <motion.p variants={childV} className="mt-7 text-base leading-7" style={{ color: 'var(--text2)' }}>KinkSync gaat over seks, kink, fantasieën en grenzen.</motion.p>
      <motion.p variants={childV} className="mt-4 text-sm leading-6" style={{ color: 'var(--text2)' }}>Daar hoeven we niet moeilijk over te doen.</motion.p>
      <motion.p variants={childV} className="mt-4 text-sm font-medium leading-6">Je leeftijd wel.</motion.p>
    </div>
  );
}
...
function Discover() {
  return (
    <div>
      ...
      <motion.p variants={childV} className="mt-6 text-sm leading-6" style={{ color: 'var(--text2)' }}>We stellen vragen.</motion.p>
      <motion.p variants={childV} className="mt-3 text-sm font-medium leading-6">Jij kiest wat erbij past.</motion.p>
      <motion.div variants={childV} className="mt-7 overflow-hidden rounded-2xl border px-5 py-5" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
      ...
      <motion.p variants={childV} className="mt-7 text-sm leading-6" style={{ color: 'var(--text2)' }}>Raakt iets je interesse?</motion.p>
      <motion.p variants={childV} className="mt-3 text-sm leading-6" style={{ color: 'var(--text2)' }}>Dan kunnen we wat verder graven.</motion.p>
      <motion.p variants={childV} className="mt-5 text-sm leading-6" style={{ color: 'var(--text2)' }}>Niet jouw ding?</motion.p>
      <motion.p variants={childV} className="mt-3 text-sm leading-6" style={{ color: 'var(--text2)' }}>Dan laten we het met rust.</motion.p>
      <motion.p variants={childV} className="mt-5 text-sm font-medium leading-6">Wij kiezen de volgende vraag.</motion.p>
      <motion.p variants={childV} className="mt-3 text-sm font-medium leading-6">Nooit jouw antwoord.</motion.p>
    </div>
  );
}
...
function Together() {
  return (
    <div>
      ...
      <motion.p variants={childV} className="mt-6 text-base leading-7">Want hier wordt KinkSync leuk.</motion.p>
      <motion.div variants={childV} className="mt-7 grid grid-cols-[1fr_auto_1fr] items-center gap-3 rounded-2xl border px-5 py-5" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
        <div className="rounded-xl px-3 py-4 text-center" style={{ background: 'var(--surface2)' }}><span className="text-xs font-semibold">Jij</span></div>
        <UsersThree size={19} aria-hidden="true" style={{ color: 'var(--accent)' }} />
        <div className="rounded-xl px-3 py-4 text-center" style={{ background: 'var(--surface2)' }}><span className="text-xs font-semibold">De ander</span></div>
      </motion.div>
      <motion.p variants={childV} className="mt-7 text-sm leading-6" style={{ color: 'var(--text2)' }}>Leg jullie profielen naast elkaar.</motion.p>
      <motion.p variants={childV} className="mt-4 text-sm leading-6" style={{ color: 'var(--text2)' }}>Dan zie je wat jullie allebei willen, waar nog een gesprek tussen zit en waar de grens gewoon staat.</motion.p>
      <motion.div variants={childV} className="mt-7 rounded-xl border-l-2 py-3 pl-4 pr-3 text-sm leading-6" style={{ borderColor: 'var(--accent)', color: 'var(--text)' }}>
        <strong className="block">Een match is geen toestemming.</strong>
        <span className="mt-2 block">Blijf praten.</span>
      </motion.div>
    </div>
  );
}
...
function Privacy({ bioAvailable }: { bioAvailable: boolean }) {
  return (
    <div>
      ...
      <motion.p variants={childV} className="mt-6 text-base leading-7">Nou ja.</motion.p>
      <motion.p variants={childV} className="mt-3 text-base leading-7">Tot jij op delen drukt.</motion.p>
      <motion.div variants={childV} className="mt-7 rounded-2xl border px-5 py-5" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
        <div className="flex items-start gap-3.5">
          <Lock size={20} className="mt-0.5 flex-none" aria-hidden="true" style={{ color: 'var(--accent)' }} />
          <div>
            <p className="text-sm font-semibold">Op jouw toestel</p>
            <p className="mt-3 text-xs leading-5" style={{ color: 'var(--text2)' }}>Profielen, antwoorden en contracten.</p>
            <p className="mt-3 text-xs leading-5" style={{ color: 'var(--text2)' }}>Geen account.</p>
            <p className="mt-2 text-xs leading-5" style={{ color: 'var(--text2)' }}>Geen centrale database.</p>
          </div>
        </div>
        <div className="my-6 h-px" style={{ background: 'var(--border)' }} />
        <div className="flex items-start gap-3.5">
          <QrCode size={20} className="mt-0.5 flex-none" aria-hidden="true" style={{ color: 'var(--accent)' }} />
          <div>
            <p className="text-sm font-semibold">Jij kiest wat vertrekt</p>
            <p className="mt-3 text-xs leading-5" style={{ color: 'var(--text2)' }}>QR, link, export of back-up.</p>
            <p className="mt-3 text-xs leading-5" style={{ color: 'var(--text2)' }}>Niets synchroniseert stilletjes.</p>
          </div>
        </div>
      </motion.div>
      <motion.p variants={childV} className="mt-7 text-sm leading-6" style={{ color: 'var(--text2)' }}>Wil je nieuwsgierige vingers buiten houden?</motion.p>
      <motion.p variants={childV} className="mt-3 text-sm font-medium leading-6">Zet er een PIN{bioAvailable ? ' en eventueel biometrie' : ''} op.</motion.p>
    </div>
  );
}
...
function Pin({ sub, digits, shake, onKey }: { sub: 'pin1' | 'pin2'; digits: string[]; shake: boolean; onKey: (key: string) => void }) {
  return (
    <div className="mx-auto max-w-[18rem] text-center">
      ...
      {sub === 'pin1' ? (
        <>
          <motion.p variants={childV} className="mt-5 text-sm leading-6" style={{ color: 'var(--text2)' }}>Vier cijfers.</motion.p>
          <motion.p variants={childV} className="mt-3 text-sm leading-6" style={{ color: 'var(--text2)' }}>Hou ze voor jezelf.</motion.p>
        </>
      ) : (
        <motion.p variants={childV} className="mt-5 text-sm leading-6" style={{ color: 'var(--text2)' }}>Voer dezelfde PIN opnieuw in.</motion.p>
      )}
      <motion.div variants={childV} animate={shake ? { x: [0, -8, 8, -6, 6, 0] } : undefined} transition={shake ? SHAKE_ANIM : undefined} className="my-7 flex justify-center gap-3.5">
...
function Biometric({ bioError }: { bioError: string | null }) {
  return (
    <div>
      <motion.div variants={childV} className="mb-5 flex h-11 w-11 items-center justify-center rounded-2xl" style={{ background: 'var(--surface2)', color: 'var(--accent)' }}><Fingerprint size={22} aria-hidden="true" /></motion.div>
      <Eyebrow>Extra slot</Eyebrow>
      <Title>PIN staat erop.</Title>
      <motion.p variants={childV} className="mt-6 text-sm leading-6" style={{ color: 'var(--text2)' }}>Wil je ook Face ID of je vingerafdruk gebruiken?</motion.p>
      <motion.p variants={childV} className="mt-4 text-sm leading-6" style={{ color: 'var(--text2)' }}>Je PIN blijft altijd beschikbaar als terugval.</motion.p>
      {bioError && <motion.p variants={childV} className="mt-6 whitespace-pre-line text-sm leading-6" style={{ color: 'var(--hard-no)' }}>{bioError}</motion.p>}
    </div>
  );
}
...
function Finale() {
  return (
    <div className="py-2 text-center">
      ...
      <motion.h2 variants={childV} className="serif-safe mt-8 text-4xl leading-tight" style={{ fontFamily: 'var(--font-display, Georgia, serif)', fontWeight: 500 }}>Zin om te beginnen?</motion.h2>
      <motion.p variants={childV} className="mx-auto mt-7 max-w-xs text-sm leading-6" style={{ color: 'var(--text2)' }}>Mooi.</motion.p>
      <motion.p variants={childV} className="mx-auto mt-4 max-w-xs text-sm leading-6" style={{ color: 'var(--text2)' }}>Vanaf hier is het aan jou.</motion.p>
      <motion.p variants={childV} className="mx-auto mt-5 max-w-xs text-sm font-medium leading-6">Maak een profiel wanneer je wilt.</motion.p>
      <motion.p variants={childV} className="mx-auto mt-3 max-w-xs text-sm font-medium leading-6">De vragen staan al klaar.</motion.p>
    </div>
  );
}