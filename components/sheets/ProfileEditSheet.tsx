    ...
    <Sheet open={open} onClose={onClose} scrollable aria-label="Profiel bewerken">
      ...
      >
        <div className="px-5 pb-4 flex items-center gap-3">
          ...
          >
            <PencilSimple size={21} weight="duotone" />
          </div>
        ...
        <div className="overflow-y-auto overscroll-contain px-5 pb-5 space-y-4" style={{ maxHeight: "calc(100dvh - 170px)" }}>
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <UsersThree size={17} style={{ color: "var(--accent)" }} />
            ...
            {paired ? (
              ...
              >
                {perspective === "dominant"
                  ? <Crown size={19} style={{ color: "var(--accent)" }} />
                  : <Heart size={19} style={{ color: "var(--accent)" }} />}
                <div className="min-w-0">
                  ...
                  {([
                    ...
                    return (
                      ...
                      >
                        ...
                        {active && <Check size={14} className="ml-auto" style={{ color: "var(--accent)" }} />}
                      </button>
                    );
                  })}
                </div>
          ...
          >
            <div className="flex items-center gap-2 mb-3">
              <Sparkle size={17} style={{ color: "var(--accent)" }} />
          ...
          >
            ...
            >
              ...
              {advancedOpen ? <CaretUp size={16} /> : <CaretDown size={16} />}
            </button>
