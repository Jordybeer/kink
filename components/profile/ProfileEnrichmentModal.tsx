...
import { CheckCircle, Heart, LinkSimple, Sparkle, Trash, X } from "@phosphor-icons/react";
import {
  ...
  return createPortal(
    ...
    >
      ...
      <div
        ...
        tabIndex={-1}
        className="relative z-10 flex max-h-[calc(var(--visual-viewport-height,100dvh)-var(--sheet-edge-clearance))] w-full flex-col overflow-hidden rounded-t-[24px] text-pretty shadow-2xl sm:max-h-[min(calc(var(--visual-viewport-height,100dvh)-3rem),44rem)] sm:w-[min(92vw,34rem)] sm:rounded-[24px]"
        style={{
          background: "var(--surface)",
          border: "1px solid var(--border)",
          backgroundImage: "radial-gradient(ellipse 92% 22rem at 50% 0%, color-mix(in srgb, var(--accent) 9%, transparent), transparent 76%)",
      ...
      >
        ...
        >
          <div className="min-w-0 flex-1">
            <h2 id="profile-enrichment-title" className="text-2xl font-semibold leading-tight">
              Profielinfo
            </h2>
            <p className="mt-1 max-w-[26rem] text-sm leading-5" style={{ color: "var(--text2)" }}>
              Kies zelf wat je toont en welke externe bronnen je koppelt.
            </p>
          </div>
          <button
            type="button"
        ...
        >
          <section className="py-5">
            <div className="flex items-center gap-2">
              <Heart size={18} aria-hidden="true" style={{ color: "var(--accent)" }} />
              <h3 className="text-base font-semibold">Relatiestatus</h3>
            </div>
            <p className="mt-1 text-sm leading-5" style={{ color: "var(--text2)" }}>
              Optioneel. Alleen zichtbaar wanneer jij dat kiest.
            </p>
            <label htmlFor="profile-relationship-status" className="sr-only">
              Relatiestatus
            </label>
            <select
              ...
              style={{
                backgroundColor: "color-mix(in srgb, var(--surface2) 72%, transparent)",
                border: "1px solid var(--border)",
                color: relationshipStatus ? "var(--text)" : "var(--text2)",
              }}
            >
          ...
          <section className="border-t py-5" style={{ borderColor: "var(--border)" }}>
            <div className="flex items-center gap-2">
              <LinkSimple size={18} aria-hidden="true" style={{ color: "var(--accent)" }} />
              <h3 className="text-base font-semibold">FetLife</h3>
            </div>
            <p className="mt-1 text-sm leading-5" style={{ color: "var(--text2)" }}>
          ...
          <section className="border-t py-5" style={{ borderColor: "var(--border)" }}>
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-semibold">BDSMTest</h3>
            </div>
            <p className="mt-1 text-sm leading-5" style={{ color: "var(--text2)" }}>
            ...
            {parsed?.ok && (
              <div className="mt-3 flex flex-wrap gap-2" role="status">
                <span
                  ...
                  style={{ color: "var(--yes)", border: "1px solid color-mix(in srgb, var(--yes) 30%, var(--border))" }}
                >
        ...
        >
          {error && (
            <p className="mb-3 text-sm leading-5" role="alert" style={{ color: "var(--hard-no-text)" }}>
              {error}
            </p>
          )}
